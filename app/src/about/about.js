function About() {
    ...
    return (
        <div className="max-w-3xl mx-auto p-4 space-y-4">
            ...
            <p>This is a passion project, combining my previous work experience as a chef and my current position as a frontend developer together. If you've found anything on this site, from a dodgy looking recipe to a strange looking viewport I'd love to know. Please fill out the contact form and I'll be sure to get back to you ASAP. </p>
