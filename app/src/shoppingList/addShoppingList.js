...
export default function AddToShopping({ recipe_id }) {
  ...
  async function handleClick() {
    ...
    await addToShoppingList(ingredient.fooditem_id, ingredient.quantity, ingredient.unit);  // Pass the foodName string
    
    toast.success(`${ingredient.quantity} ${ingredient.unit} ${ingredient.fooditem_name}${ingredient.quantity === 1 ? '' : 's'} added`);
        }
